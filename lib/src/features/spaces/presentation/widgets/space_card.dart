    ...
    return Card(
      ...
      child: InkWell(
        ...
        child: Column(
          ...
          children: [
            // Space colour as a top accent bar, flush inside the card's rounded
            // corners (clipBehavior clips it) — matches the web coloured top border.
            if (topColor != null) Container(height: 4, color: topColor),
            Padding(
